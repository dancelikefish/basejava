...
```
Схема хранения резюме в массиве ru.webapp.storage (в элементах от 0 до size-1 отсутствуют null):

r1, r2, r3,..., rn, null, null,..., null
<----- size ----->
<------- ru.webapp.storage.length (10000) ------->
```
...
- Протестируйте вашу реализацию с помощью классов `ru.webapp.util.MainArray.main()` и `ru.webapp.MainTestArrayStorage.main()`
...
6. `ru.webapp.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
